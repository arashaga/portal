...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rfc_rfcdocument', (
            ...
            ('rfc_project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Projects'])),
            ('rfc_issued_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rfc_issued_to', to=orm['signup.SignUp'])),
            ...
            ('rfc_issued_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rfc_issued_by', to=orm['signup.SignUp'])),
            ...
            ('rfc_answer_reviewed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rfc_ans_rev_by', to=orm['signup.SignUp'])),
            ('rfc_answered_date_architect', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('rfc_answer_authorized_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rfc_ans_auth_by', to=orm['signup.SignUp'])),
