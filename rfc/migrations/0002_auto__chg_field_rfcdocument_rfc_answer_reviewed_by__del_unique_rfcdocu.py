...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RFCDocument', fields ['rfc_issued_to']
        db.delete_unique(u'rfc_rfcdocument', ['rfc_issued_to_id'])

        # Removing unique constraint on 'RFCDocument', fields ['rfc_project']
        db.delete_unique(u'rfc_rfcdocument', ['rfc_project_id'])

        # Removing unique constraint on 'RFCDocument', fields ['rfc_issued_by']
        db.delete_unique(u'rfc_rfcdocument', ['rfc_issued_by_id'])

        # Removing unique constraint on 'RFCDocument', fields ['rfc_answer_authorized_by']
        db.delete_unique(u'rfc_rfcdocument', ['rfc_answer_authorized_by_id'])

        # Removing unique constraint on 'RFCDocument', fields ['rfc_answer_reviewed_by']
        db.delete_unique(u'rfc_rfcdocument', ['rfc_answer_reviewed_by_id'])
        ...
        # Changing field 'RFCDocument.rfc_project'
        db.alter_column(u'rfc_rfcdocument', 'rfc_project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Projects']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'RFCDocument.rfc_answer_reviewed_by'
        db.alter_column(u'rfc_rfcdocument', 'rfc_answer_reviewed_by_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['signup.SignUp']))
        # Adding unique constraint on 'RFCDocument', fields ['rfc_answer_reviewed_by']
        db.create_unique(u'rfc_rfcdocument', ['rfc_answer_reviewed_by_id'])


        # Changing field 'RFCDocument.rfc_answer_authorized_by'
        db.alter_column(u'rfc_rfcdocument', 'rfc_answer_authorized_by_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['signup.SignUp']))
        # Adding unique constraint on 'RFCDocument', fields ['rfc_answer_authorized_by']
        db.create_unique(u'rfc_rfcdocument', ['rfc_answer_authorized_by_id'])


        # Changing field 'RFCDocument.rfc_issued_by'
        db.alter_column(u'rfc_rfcdocument', 'rfc_issued_by_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['signup.SignUp']))
        # Adding unique constraint on 'RFCDocument', fields ['rfc_issued_by']
        db.create_unique(u'rfc_rfcdocument', ['rfc_issued_by_id'])


        # Changing field 'RFCDocument.rfc_project'
        db.alter_column(u'rfc_rfcdocument', 'rfc_project_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['project.Projects'], unique=True))
        # Adding unique constraint on 'RFCDocument', fields ['rfc_project']
        db.create_unique(u'rfc_rfcdocument', ['rfc_project_id'])


        # Changing field 'RFCDocument.rfc_issued_to'
        db.alter_column(u'rfc_rfcdocument', 'rfc_issued_to_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['signup.SignUp']))
        # Adding unique constraint on 'RFCDocument', fields ['rfc_issued_to']
        db.create_unique(u'rfc_rfcdocument', ['rfc_issued_to_id'])
    ...
    models = {
        ...
        u'rfc.rfcdocument': {
            ...
            'rfc_answer_authorized_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rfc_ans_auth_by'", 'to': u"orm['signup.SignUp']"}),
            'rfc_answer_issued_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'rfc_answer_reviewed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rfc_ans_rev_by'", 'to': u"orm['signup.SignUp']"}),
            ...
            'rfc_issued_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rfc_issued_by'", 'to': u"orm['signup.SignUp']"}),
            'rfc_issued_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'rfc_issued_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rfc_issued_to'", 'to': u"orm['signup.SignUp']"}),
